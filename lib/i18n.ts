...
const en = {
  ...
  offers: {
    ...
    titleA: "Light",
    titleB: "more, save more.",
    subtitle:
      "Mix any candles from the collection — the more you bring home, the better the price. Free delivery from three.",
    ...
    cards: [
      { title: "1 candle", qty: "Single", price: 149, note: "Start with one." },
      { title: "Duo", qty: "2 candles", price: 269, note: "A pair for the home." },
      { title: "Trio", qty: "3 candles", price: 379, note: "Unlocks free delivery." },
      { title: "Bundle of 5", qty: "5 candles", price: 599, note: "Best price per candle." },
    ],
    shopCta: "Shop the collection",
    fineprint:
      "Pricing applies automatically at checkout to any mix of candles. Delivery: 30 MAD across Morocco — free from 3 candles.",
  },
  shopBanner: {
    title: "Bundle offers",
    line1: "1 · 149",
    line2: "2 · 269",
    line3: "3 · 379 · Free delivery",
    line4: "5 · 599 · Free delivery",
    note: "Auto-applied at checkout. All prices in MAD.",
  },
  home: {
    collectionEyebrow: "The collection",
    collectionTitleA: "A small family",
    collectionTitleB: "of slow soy.",
    seeAllCandles: "See all candles",
  ...
  cart: {
    ...
    deliveryFree: "FREE",
    bundleApplied: "Bundle pricing applied",
    bundleSaved: (amount: string) => `You saved ${amount}`,
    addOneForFree: (n: number) =>
      `Add ${n} more candle${n > 1 ? "s" : ""} to unlock free delivery.`,
    total: "Total",
...
const fr: Dict = {
  ...
  offers: {
    ...
    titleA: "Allumez",
    titleB: "plus, économisez plus.",
    subtitle:
      "Composez votre coffret parmi toutes les bougies — plus vous en prenez, mieux c'est. Livraison offerte dès trois.",
    ...
    cards: [
      { title: "1 bougie", qty: "À l'unité", price: 149, note: "Pour commencer." },
      { title: "Duo", qty: "2 bougies", price: 269, note: "Une paire pour la maison." },
      { title: "Trio", qty: "3 bougies", price: 379, note: "Débloque la livraison offerte." },
      { title: "Coffret de 5", qty: "5 bougies", price: 599, note: "Meilleur prix à la bougie." },
    ],
    shopCta: "Découvrir la collection",
    fineprint:
      "Les tarifs s'appliquent automatiquement à toute combinaison de bougies. Livraison : 30 MAD au Maroc — offerte dès 3 bougies.",
  },
  shopBanner: {
    title: "Offres groupées",
    line1: "1 · 149",
    line2: "2 · 269",
    line3: "3 · 379 · Livraison offerte",
    line4: "5 · 599 · Livraison offerte",
    note: "Appliqué automatiquement. Tous les prix en MAD.",
  },
  home: {
    collectionEyebrow: "La collection",
    collectionTitleA: "Une petite famille",
    collectionTitleB: "de soja lent.",
    seeAllCandles: "Voir toutes les bougies",
    noProducts:
  ...
  cart: {
    ...
    deliveryFree: "OFFERTE",
    bundleApplied: "Tarif groupé appliqué",
    bundleSaved: (amount: string) => `Vous économisez ${amount}`,
    addOneForFree: (n: number) =>
      `Ajoutez ${n} bougie${n > 1 ? "s" : ""} pour la livraison offerte.`,
    total: "Total",
